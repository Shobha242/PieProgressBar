...
*/
    ...
    public PieAndBGprogressView(Context context, AttributeSet attrs) {
        ...
        int mColorWhite = res.getColor(R.color.white);

        mBackgroundPaintCircle = new Paint();
        mBackgroundPaintCircle.setColor(mColorRed);
        //mBackgroundPaintCircle.clearShadowLayer();
        mBackgroundPaintCircle.setStrokeWidth(13f);

        mBackgroundPaintCircle.setStyle(Paint.Style.FILL);


        mProgressPaintCircle = new Paint();
        mProgressPaintCircle.setColor(mColorWhite);
       // mProgressPaintCircle.clearShadowLayer();
        mProgressPaintCircle.setStyle(Paint.Style.FILL);
        mProgressPaintCircle.setStrokeWidth(3f);
